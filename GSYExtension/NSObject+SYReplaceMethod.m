...
/// 替换实例的两个方法
+ (void)replaceInstanceMethod:(SEL)originalSelector toMethod:(SEL)swizzledSelector
{
    // 类名
...
/// 替换类的两个方法
+ (void)replaceClassMethod:(SEL)originalSelector toMethod:(SEL)swizzledSelector
{
    // 类名
